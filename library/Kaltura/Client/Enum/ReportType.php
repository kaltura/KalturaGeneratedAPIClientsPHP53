...
class ReportType extends \Kaltura\Client\EnumBase
{
	...
	const PARTNER_USAGE_HIGHLIGHTS = "63";
	...
	const DOCUMENT_ENTRY_HIGHLIGHTS = "70";
	const DOCUMENT_ENTRY_MAP_OVERLAY_COUNTRY = "71";
	const DOCUMENT_ENTRY_MAP_OVERLAY_REGION = "72";
