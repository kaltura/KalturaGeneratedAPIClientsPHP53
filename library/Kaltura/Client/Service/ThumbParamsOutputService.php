 ...
 * @subpackage Client
 */
class ThumbParamsOutputService extends \Kaltura\Client\ServiceBase
{
	 ...
	 */
	function listAction(\Kaltura\Client\Type\ThumbParamsOutputFilter $filter = null, \Kaltura\Client\Type\FilterPager $pager = null)
	{
		$kparams = array();
		if ($filter !== null)
