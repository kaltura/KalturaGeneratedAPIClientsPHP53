...
class DocumentService extends \Kaltura\Client\ServiceBase
{
	...
	function addFromUploadedFile(\Kaltura\Client\Plugin\Document\Type\DocumentEntry $documentEntry, $uploadTokenId)
	{
		...
		$this->client->queueServiceActionCall("document", "addFromUploadedFile", "KalturaDocumentEntry", $kparams);
	...
	function addFromEntry($sourceEntryId, \Kaltura\Client\Plugin\Document\Type\DocumentEntry $documentEntry = null, $sourceFlavorParamsId = null)
	{
		...
		$this->client->queueServiceActionCall("document", "addFromEntry", "KalturaDocumentEntry", $kparams);
		if ($this->client->isMultiRequest())
			return $this->client->getMultiRequestResult();
		$resultXml = $this->client->doQueue();
		$resultXmlObject = new \SimpleXMLElement($resultXml);
	...
	function addFromFlavorAsset($sourceFlavorAssetId, \Kaltura\Client\Plugin\Document\Type\DocumentEntry $documentEntry = null)
	{
		...
		if ($documentEntry !== null)
			$this->client->addParam($kparams, "documentEntry", $documentEntry->toParams());
		$this->client->queueServiceActionCall("document", "addFromFlavorAsset", "KalturaDocumentEntry", $kparams);
		if ($this->client->isMultiRequest())
			return $this->client->getMultiRequestResult();
		$resultXml = $this->client->doQueue();
		$resultXmlObject = new \SimpleXMLElement($resultXml);
	...
	function convert($entryId, $conversionProfileId = null, array $dynamicConversionAttributes = null)
	{
		...
		$this->client->queueServiceActionCall("document", "convert", null, $kparams);
		if ($this->client->isMultiRequest())
			return $this->client->getMultiRequestResult();
		$resultXml = $this->client->doQueue();
		$resultXmlObject = new \SimpleXMLElement($resultXml);
	...
	function get($entryId, $version = -1)
	{
		...
		$this->client->queueServiceActionCall("document", "get", "KalturaDocumentEntry", $kparams);
		if ($this->client->isMultiRequest())
			return $this->client->getMultiRequestResult();
		$resultXml = $this->client->doQueue();
		$resultXmlObject = new \SimpleXMLElement($resultXml);
	...
	function update($entryId, \Kaltura\Client\Plugin\Document\Type\DocumentEntry $documentEntry)
	{
		...
		$this->client->addParam($kparams, "entryId", $entryId);
		$this->client->addParam($kparams, "documentEntry", $documentEntry->toParams());
		$this->client->queueServiceActionCall("document", "update", "KalturaDocumentEntry", $kparams);
		if ($this->client->isMultiRequest())
			return $this->client->getMultiRequestResult();
		$resultXml = $this->client->doQueue();
		$resultXmlObject = new \SimpleXMLElement($resultXml);
	...
	function delete($entryId)
	{
		$kparams = array();
		$this->client->addParam($kparams, "entryId", $entryId);
		$this->client->queueServiceActionCall("document", "delete", null, $kparams);
		if ($this->client->isMultiRequest())
			return $this->client->getMultiRequestResult();
		$resultXml = $this->client->doQueue();
		$resultXmlObject = new \SimpleXMLElement($resultXml);
	...
	function listAction(\Kaltura\Client\Plugin\Document\Type\DocumentEntryFilter $filter = null, \Kaltura\Client\Type\FilterPager $pager = null)
	{
		...
		$this->client->queueServiceActionCall("document", "list", "KalturaDocumentListResponse", $kparams);
		if ($this->client->isMultiRequest())
			return $this->client->getMultiRequestResult();
		$resultXml = $this->client->doQueue();
		$resultXmlObject = new \SimpleXMLElement($resultXml);
	...
	function upload($fileData)
	{
		...
		$this->client->queueServiceActionCall("document", "upload", null, $kparams, $kfiles);
		if ($this->client->isMultiRequest())
			return $this->client->getMultiRequestResult();
		$resultXml = $this->client->doQueue();
		$resultXmlObject = new \SimpleXMLElement($resultXml);
	...
	function serve($entryId, $flavorAssetId = null, $forceProxy = false)
	{
		...
		$this->client->queueServiceActionCall('document', 'serve', null, $kparams);
	...
	function serveByFlavorParamsId($entryId, $flavorParamsId = null, $forceProxy = false)
	{
		...
		$this->client->addParam($kparams, "forceProxy", $forceProxy);
		$this->client->queueServiceActionCall('document', 'serveByFlavorParamsId', null, $kparams);
		$resultObject = $this->client->getServeUrl();
		return $resultObject;
	}
	...
	function approveReplace($entryId)
	{
		$kparams = array();
		$this->client->addParam($kparams, "entryId", $entryId);
		$this->client->queueServiceActionCall("document", "approveReplace", "KalturaDocumentEntry", $kparams);
		if ($this->client->isMultiRequest())
			return $this->client->getMultiRequestResult();
		$resultXml = $this->client->doQueue();
		$resultXmlObject = new \SimpleXMLElement($resultXml);
