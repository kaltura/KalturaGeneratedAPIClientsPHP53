 ...
 * @subpackage Client
 */
class PlayableEntryCompareAttributeCondition extends \Kaltura\Client\Type\SearchComparableAttributeCondition
{
	...
	/**
	 * 
	 * @var \Kaltura\Client\Enum\PlayableEntryCompareAttribute
	 */
