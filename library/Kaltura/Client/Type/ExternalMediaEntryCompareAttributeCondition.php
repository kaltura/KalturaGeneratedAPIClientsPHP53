 ...
 * @subpackage Client
 */
class ExternalMediaEntryCompareAttributeCondition extends \Kaltura\Client\Type\SearchComparableAttributeCondition
{
	...
	/**
	 * 
	 * @var \Kaltura\Client\Enum\ExternalMediaEntryCompareAttribute
	 */
