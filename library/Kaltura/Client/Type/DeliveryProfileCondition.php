 ...
 * @subpackage Client
 */
class DeliveryProfileCondition extends \Kaltura\Client\Type\Condition
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->deliveryProfileIds))
		{
			if(empty($xml->deliveryProfileIds))
				...
				$this->deliveryProfileIds = \Kaltura\Client\ParseUtils::unmarshalArray($xml->deliveryProfileIds, "KalturaIntegerValue");
		}
	}
	/**
