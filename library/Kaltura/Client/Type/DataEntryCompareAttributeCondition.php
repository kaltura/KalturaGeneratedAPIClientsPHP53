 ...
 * @subpackage Client
 */
class DataEntryCompareAttributeCondition extends \Kaltura\Client\Type\SearchComparableAttributeCondition
{
	...
	/**
	 * 
	 * @var \Kaltura\Client\Enum\DataEntryCompareAttribute
	 */
