 ...
 * @subpackage Client
 */
class LiveStreamAdminEntryCompareAttributeCondition extends \Kaltura\Client\Type\SearchComparableAttributeCondition
{
	...
	/**
	 * 
	 * @var \Kaltura\Client\Enum\LiveStreamAdminEntryCompareAttribute
	 */
