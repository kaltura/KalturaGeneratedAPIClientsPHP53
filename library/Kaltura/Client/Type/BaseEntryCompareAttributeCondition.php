 ...
 * @subpackage Client
 */
class BaseEntryCompareAttributeCondition extends \Kaltura\Client\Type\SearchComparableAttributeCondition
{
	...
	/**
	 * 
	 * @var \Kaltura\Client\Enum\BaseEntryCompareAttribute
	 */
