 ...
 * @subpackage Client
 */
class RecommendationProfile extends \Kaltura\Client\ObjectBase
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->recommendationEngineSettings))
		{
			if(empty($xml->recommendationEngineSettings))
				$this->recommendationEngineSettings = array();
			else
				$this->recommendationEngineSettings = \Kaltura\Client\ParseUtils::unmarshalMap($xml->recommendationEngineSettings, "KalturaStringValue");
		}
