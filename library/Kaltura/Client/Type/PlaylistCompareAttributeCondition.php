 ...
 * @subpackage Client
 */
class PlaylistCompareAttributeCondition extends \Kaltura\Client\Type\SearchComparableAttributeCondition
{
	...
	/**
	 * 
	 * @var \Kaltura\Client\Enum\PlaylistCompareAttribute
	 */
