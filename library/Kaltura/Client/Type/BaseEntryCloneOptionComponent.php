 ...
 * @subpackage Client
 */
class BaseEntryCloneOptionComponent extends \Kaltura\Client\Type\BaseEntryCloneOptionItem
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->rule))
			$this->rule = (string)$xml->rule;
	}
	/**
	 * 
	 * @var \Kaltura\Client\Enum\BaseEntryCloneOptions
	 */
