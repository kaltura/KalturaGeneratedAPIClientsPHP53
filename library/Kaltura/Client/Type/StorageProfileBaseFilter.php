 ...
 * @subpackage Client
 */
abstract class StorageProfileBaseFilter extends \Kaltura\Client\Type\Filter
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->protocolEqual))
			$this->protocolEqual = (string)$xml->protocolEqual;
		if(count($xml->protocolIn))
			$this->protocolIn = (string)$xml->protocolIn;
	}
	/**
	 * 
	 * @var int
