 ...
 * @subpackage Client
 */
class PlaybackContextResult extends \Kaltura\Client\ObjectBase
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->restrictions))
		{
			if(empty($xml->restrictions))
				...
				$this->restrictions = \Kaltura\Client\ParseUtils::unmarshalArray($xml->restrictions, "KalturaPlaybackRestriction");
		}
	}
	/**
	 * 
	...
	/**
	 * Array of actions as received from the rules that invalidated
	 * @var array<KalturaPlaybackRestriction>
	 */
	public $restrictions;
