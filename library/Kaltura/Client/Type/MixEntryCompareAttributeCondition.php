 ...
 * @subpackage Client
 */
class MixEntryCompareAttributeCondition extends \Kaltura\Client\Type\SearchComparableAttributeCondition
{
	...
	/**
	 * 
	 * @var \Kaltura\Client\Enum\MixEntryCompareAttribute
	 */
