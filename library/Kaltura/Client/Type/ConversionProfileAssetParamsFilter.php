 ...
 * @subpackage Client
 */
class ConversionProfileAssetParamsFilter extends \Kaltura\Client\Type\ConversionProfileAssetParamsBaseFilter
{
	...
	/**
	 * 
	 * @var \Kaltura\Client\Type\ConversionProfileFilter
	 */
	public $conversionProfileIdFilter;

	/**
	 * 
	 * @var \Kaltura\Client\Type\AssetParamsFilter
	 */
