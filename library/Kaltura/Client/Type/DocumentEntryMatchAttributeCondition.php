 ...
 * @subpackage Client
 */
class DocumentEntryMatchAttributeCondition extends \Kaltura\Client\Type\SearchMatchAttributeCondition
{
	...
	/**
	 * 
	 * @var \Kaltura\Client\Enum\DocumentEntryMatchAttribute
	 */
