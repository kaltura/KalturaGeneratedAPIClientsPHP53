 ...
 * @subpackage Client
 */
class BaseEntry extends \Kaltura\Client\ObjectBase
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		{
			if(!empty($xml->blockAutoTranscript) && $xml->blockAutoTranscript != 'false')
	...
	/**
	 * 
	 * @var \Kaltura\Client\Enum\EntryStatus
	 * @readonly
	 */
	public $status = null;
	 ...
	 * @var \Kaltura\Client\Enum\EntryReplacementStatus
	 * @readonly
	 */
