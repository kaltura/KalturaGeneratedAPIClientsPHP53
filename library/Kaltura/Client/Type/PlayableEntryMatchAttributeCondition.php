 ...
 * @subpackage Client
 */
class PlayableEntryMatchAttributeCondition extends \Kaltura\Client\Type\SearchMatchAttributeCondition
{
	...
	/**
	 * 
	 * @var \Kaltura\Client\Enum\PlayableEntryMatchAttribute
	 */
