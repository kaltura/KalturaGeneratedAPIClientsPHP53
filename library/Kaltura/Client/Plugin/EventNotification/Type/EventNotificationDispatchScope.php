 ...
 * @subpackage Client
 */
class EventNotificationDispatchScope extends \Kaltura\Client\Plugin\EventNotification\Type\EventNotificationScope
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->dynamicValues))
		{
			if(empty($xml->dynamicValues))
				...
				$this->dynamicValues = \Kaltura\Client\ParseUtils::unmarshalArray($xml->dynamicValues, "KalturaKeyValue");
		}
	}
	/**
	 * 
