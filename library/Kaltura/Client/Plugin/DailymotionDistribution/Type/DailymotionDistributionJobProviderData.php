 ...
 * @subpackage Client
 */
class DailymotionDistributionJobProviderData extends \Kaltura\Client\Plugin\ContentDistribution\Type\ConfigurableDistributionJobProviderData
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->captionsInfo))
		{
			if(empty($xml->captionsInfo))
				...
				$this->captionsInfo = \Kaltura\Client\ParseUtils::unmarshalArray($xml->captionsInfo, "KalturaDailymotionDistributionCaptionInfo");
		}
	}
	/**
	 * 
	...
	/**
	 * 
	 * @var array<KalturaDailymotionDistributionCaptionInfo>
	 */
	public $captionsInfo;
