 ...
 * @namespace
 */
namespace Kaltura\Client\Plugin\ScheduledTaskEventNotification\Type;

/**
 * @package Kaltura
 * @subpackage Client
 */
class DispatchEventNotificationObjectTask extends \Kaltura\Client\Plugin\ScheduledTask\Type\ObjectTask
{
