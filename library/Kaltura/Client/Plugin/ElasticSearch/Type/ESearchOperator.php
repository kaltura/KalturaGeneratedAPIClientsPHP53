 ...
 * @subpackage Client
 */
class ESearchOperator extends \Kaltura\Client\Plugin\ElasticSearch\Type\ESearchBaseItem
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->searchItems))
		{
			if(empty($xml->searchItems))
				...
				$this->searchItems = \Kaltura\Client\ParseUtils::unmarshalArray($xml->searchItems, "KalturaESearchBaseItem");
		}
	}
	/**
	 * 
	...
	/**
	 * 
	 * @var array<KalturaESearchBaseItem>
	 */
	public $searchItems;
