 ...
 * @subpackage Client
 */
class MicrosoftTeamsDropFolder extends \Kaltura\Client\Plugin\DropFolder\Type\RemoteDropFolder
{
	public function getKalturaObjectType()
	{
		return 'KalturaMicrosoftTeamsDropFolder';
	}
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->integrationId))
			$this->integrationId = (int)$xml->integrationId;
		if(count($xml->tenantId))
			$this->tenantId = (string)$xml->tenantId;
