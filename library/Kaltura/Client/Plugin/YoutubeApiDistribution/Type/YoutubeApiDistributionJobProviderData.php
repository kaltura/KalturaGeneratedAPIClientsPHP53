 ...
 * @subpackage Client
 */
class YoutubeApiDistributionJobProviderData extends \Kaltura\Client\Plugin\ContentDistribution\Type\ConfigurableDistributionJobProviderData
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->captionsInfo))
		{
			if(empty($xml->captionsInfo))
				...
				$this->captionsInfo = \Kaltura\Client\ParseUtils::unmarshalArray($xml->captionsInfo, "KalturaYouTubeApiCaptionDistributionInfo");
		}
	}
	/**
	 * 
	...
	/**
	 * 
	 * @var array<KalturaYouTubeApiCaptionDistributionInfo>
	 */
	public $captionsInfo;
