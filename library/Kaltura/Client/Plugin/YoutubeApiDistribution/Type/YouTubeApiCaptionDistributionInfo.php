 ...
 * @subpackage Client
 */
class YouTubeApiCaptionDistributionInfo extends \Kaltura\Client\ObjectBase
{
	...
	/**
	 * 
	 * @var \Kaltura\Client\Plugin\YoutubeApiDistribution\Enum\YouTubeApiDistributionCaptionAction
	 */
	public $action = null;
