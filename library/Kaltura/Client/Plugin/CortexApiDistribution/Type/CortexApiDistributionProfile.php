 ...
 * @subpackage Client
 */
class CortexApiDistributionProfile extends \Kaltura\Client\Plugin\ContentDistribution\Type\ConfigurableDistributionProfile
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->metadataprofileidpushing))
