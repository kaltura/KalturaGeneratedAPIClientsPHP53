 ...
 * @subpackage Client
 */
class CortexApiCaptionDistributionInfo extends \Kaltura\Client\ObjectBase
{
	...
	/**
	 * 
	 * @var \Kaltura\Client\Plugin\CortexApiDistribution\Enum\CortexApiDistributionCaptionAction
	 */
	public $action = null;
