 ...
 * @subpackage Client
 */
abstract class ScheduledTaskProfileBaseFilter extends \Kaltura\Client\Type\Filter
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->lastExecutionStartedAtGreaterThanOrEqual))
		...
		if(count($xml->objectFilterEngineTypeIn))
