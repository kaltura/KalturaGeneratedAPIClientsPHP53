 ...
 * @subpackage Client
 */
abstract class ObjectTask extends \Kaltura\Client\ObjectBase
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		{
			if(!empty($xml->stopProcessingOnError) && $xml->stopProcessingOnError != 'false')
	...
	/**
	 * 
	 * @var \Kaltura\Client\Plugin\ScheduledTask\Enum\ObjectTaskType
	 * @readonly
	 */
	public $type = null;
