 ...
 * @namespace
 */
namespace Kaltura\Client\Plugin\SearchHistory\Service;

/**
 * @package Kaltura
 * @subpackage Client
 */
class SearchHistoryService extends \Kaltura\Client\ServiceBase
{
	...
	function listAction(\Kaltura\Client\Plugin\SearchHistory\Type\ESearchHistoryFilter $filter = null)
	{
		...
		$resultXmlObject = new \SimpleXMLElement($resultXml);
		$this->client->checkIfError($resultXmlObject->result);
		$resultObject = \Kaltura\Client\ParseUtils::unmarshalObject($resultXmlObject->result, "KalturaESearchHistoryListResponse");
		$this->client->validateObjectType($resultObject, "\\Kaltura\\Client\\Plugin\\SearchHistory\\Type\\ESearchHistoryListResponse");
		return $resultObject;
	}
}
