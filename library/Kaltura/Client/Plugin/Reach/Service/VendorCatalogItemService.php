...
class VendorCatalogItemService extends \Kaltura\Client\ServiceBase
{
	 ...
	 */
	function addFromBulkUpload($fileData, \Kaltura\Client\Type\BulkUploadJobData $bulkUploadData = null, \Kaltura\Client\Type\BulkUploadVendorCatalogItemData $bulkUploadVendorCatalogItemData = null)
	{
		$kparams = array();
		$kfiles = array();
	 ...
	 * @return file
	 */
	function serve($vendorPartnerId = null, \Kaltura\Client\Plugin\Reach\Type\VendorCatalogItemFilter $filter = null)
	{
		if ($this->client->isMultiRequest())
