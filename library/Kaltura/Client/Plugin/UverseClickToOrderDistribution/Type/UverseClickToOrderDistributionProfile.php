 ...
 * @namespace
 */
namespace Kaltura\Client\Plugin\UverseClickToOrderDistribution\Type;

/**
 * @package Kaltura
 * @subpackage Client
 */
class UverseClickToOrderDistributionProfile extends \Kaltura\Client\Plugin\ContentDistribution\Type\ConfigurableDistributionProfile
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->backgroundImageWide))
			$this->backgroundImageWide = (string)$xml->backgroundImageWide;
		if(count($xml->backgroundImageStandard))
