 ...
 * @namespace
 */
namespace Kaltura\Client\Plugin\UverseClickToOrderDistribution\Service;
 ...
 * @subpackage Client
 */
class UverseClickToOrderService extends \Kaltura\Client\ServiceBase
{
	...
	function getFeed($distributionProfileId, $hash)
	{
		...
		$this->client->queueServiceActionCall('uverseclicktoorderdistribution_uverseclicktoorder', 'getFeed', null, $kparams);
