 ...
 * @namespace
 */
namespace Kaltura\Client\Plugin\AttUverseDistribution\Service;
 ...
 * @subpackage Client
 */
class AttUverseService extends \Kaltura\Client\ServiceBase
{
	...
	function getFeed($distributionProfileId, $hash)
	{
		...
		$this->client->queueServiceActionCall('attuversedistribution_attuverse', 'getFeed', null, $kparams);
