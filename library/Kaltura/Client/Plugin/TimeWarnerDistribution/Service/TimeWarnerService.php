 ...
 * @namespace
 */
namespace Kaltura\Client\Plugin\TimeWarnerDistribution\Service;
 ...
 * @subpackage Client
 */
class TimeWarnerService extends \Kaltura\Client\ServiceBase
{
	...
	function getFeed($distributionProfileId, $hash)
	{
		...
		$this->client->queueServiceActionCall('timewarnerdistribution_timewarner', 'getFeed', null, $kparams);
