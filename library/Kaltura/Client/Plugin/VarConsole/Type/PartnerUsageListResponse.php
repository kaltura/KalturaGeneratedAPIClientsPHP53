 ...
 * @subpackage Client
 */
class PartnerUsageListResponse extends \Kaltura\Client\Type\ListResponse
{
	...
	/**
	 * 
	 * @var \Kaltura\Client\Plugin\VarConsole\Type\VarPartnerUsageItem
	 */
	public $total;

	/**
	 * 
	 * @var array<KalturaVarPartnerUsageItem>
	 */
	public $objects;
