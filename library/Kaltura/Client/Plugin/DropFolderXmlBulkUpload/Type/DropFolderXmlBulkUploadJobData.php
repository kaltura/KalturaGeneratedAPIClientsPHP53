 ...
 * @subpackage Client
 */
class DropFolderXmlBulkUploadJobData extends \Kaltura\Client\Plugin\BulkUploadXml\Type\BulkUploadXmlJobData
{
	public function getKalturaObjectType()
	{
		return 'KalturaDropFolderXmlBulkUploadJobData';
	}
