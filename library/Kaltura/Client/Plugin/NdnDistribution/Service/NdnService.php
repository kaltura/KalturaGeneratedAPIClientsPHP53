 ...
 * @namespace
 */
namespace Kaltura\Client\Plugin\NdnDistribution\Service;
 ...
 * @subpackage Client
 */
class NdnService extends \Kaltura\Client\ServiceBase
{
	...
	function getFeed($distributionProfileId, $hash)
	{
		...
		$this->client->queueServiceActionCall('ndndistribution_ndn', 'getFeed', null, $kparams);
