 ...
 * @subpackage Client
 */
class FreewheelGenericDistributionJobProviderData extends \Kaltura\Client\Plugin\ContentDistribution\Type\ConfigurableDistributionJobProviderData
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->videoAssetFilePaths))
		{
			if(empty($xml->videoAssetFilePaths))
				...
				$this->videoAssetFilePaths = \Kaltura\Client\ParseUtils::unmarshalArray($xml->videoAssetFilePaths, "KalturaString");
		}
		...
		if(count($xml->cuePoints))
		{
			if(empty($xml->cuePoints))
				...
				$this->cuePoints = \Kaltura\Client\ParseUtils::unmarshalArray($xml->cuePoints, "KalturaCuePoint");
		}
	}
	/**
