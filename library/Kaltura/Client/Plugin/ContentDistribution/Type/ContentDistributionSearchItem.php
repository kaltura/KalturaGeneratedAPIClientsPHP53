 ...
 * @subpackage Client
 */
class ContentDistributionSearchItem extends \Kaltura\Client\Type\SearchItem
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		{
			if(!empty($xml->noDistributionProfiles) && $xml->noDistributionProfiles != 'false')
		...
		{
			if(!empty($xml->hasEntryDistributionValidationErrors) && $xml->hasEntryDistributionValidationErrors != 'false')
	...
	/**
	 * 
	 * @var \Kaltura\Client\Plugin\ContentDistribution\Enum\EntryDistributionSunStatus
	 */
	public $distributionSunStatus = null;

	/**
	 * 
	 * @var \Kaltura\Client\Plugin\ContentDistribution\Enum\EntryDistributionFlag
	 */
	public $entryDistributionFlag = null;

	/**
	 * 
	 * @var \Kaltura\Client\Plugin\ContentDistribution\Enum\EntryDistributionStatus
	 */
