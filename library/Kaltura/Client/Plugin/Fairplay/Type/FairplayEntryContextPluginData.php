 ...
 * @namespace
 */
namespace Kaltura\Client\Plugin\Fairplay\Type;

/**
 * @package Kaltura
 * @subpackage Client
 */
class FairplayEntryContextPluginData extends \Kaltura\Client\Type\PluginData
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->publicCertificate))
			$this->publicCertificate = (string)$xml->publicCertificate;
	}
	/**
