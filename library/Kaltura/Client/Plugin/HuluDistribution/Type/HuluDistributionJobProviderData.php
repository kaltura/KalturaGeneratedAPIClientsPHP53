 ...
 * @subpackage Client
 */
class HuluDistributionJobProviderData extends \Kaltura\Client\Plugin\ContentDistribution\Type\ConfigurableDistributionJobProviderData
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->captionLocalPaths))
		{
			if(empty($xml->captionLocalPaths))
				...
				$this->captionLocalPaths = \Kaltura\Client\ParseUtils::unmarshalArray($xml->captionLocalPaths, "KalturaString");
		}
	}
	/**
	 * 
