 ...
 * @namespace
 */
namespace Kaltura\Client\Plugin\KafkaNotification\Type;

/**
 * @package Kaltura
 * @subpackage Client
 */
class KafkaNotificationTemplate extends \Kaltura\Client\Plugin\EventNotification\Type\EventNotificationTemplate
{
	...
	/**
	 * Define the content dynamic parameters
	 * @var \Kaltura\Client\Plugin\KafkaNotification\Enum\KafkaNotificationFormat
	 */
