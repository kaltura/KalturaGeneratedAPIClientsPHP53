 ...
 * @subpackage Client
 */
class BusinessProcessSignalNotificationTemplate extends \Kaltura\Client\Plugin\BusinessProcessNotification\Type\BusinessProcessNotificationTemplate
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->eventId))
			$this->eventId = (string)$xml->eventId;
	}
	/**
