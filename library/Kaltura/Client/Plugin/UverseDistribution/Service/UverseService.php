 ...
 * @namespace
 */
namespace Kaltura\Client\Plugin\UverseDistribution\Service;
 ...
 * @subpackage Client
 */
class UverseService extends \Kaltura\Client\ServiceBase
{
	...
	function getFeed($distributionProfileId, $hash)
	{
		...
		$this->client->queueServiceActionCall('uversedistribution_uverse', 'getFeed', null, $kparams);
