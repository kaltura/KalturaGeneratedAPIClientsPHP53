 ...
 * @namespace
 */
namespace Kaltura\Client\Plugin\Widevine\Service;
 ...
 * @subpackage Client
 */
class WidevineDrmService extends \Kaltura\Client\ServiceBase
{
	...
	function getLicense($flavorAssetId, $referrer = null)
	{
		...
		$this->client->queueServiceActionCall("widevine_widevinedrm", "getLicense", null, $kparams);
