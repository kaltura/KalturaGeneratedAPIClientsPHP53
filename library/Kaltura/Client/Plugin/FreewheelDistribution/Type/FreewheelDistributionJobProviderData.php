 ...
 * @subpackage Client
 */
class FreewheelDistributionJobProviderData extends \Kaltura\Client\Plugin\ContentDistribution\Type\DistributionJobProviderData
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->videoAssetFilePaths))
		{
			if(empty($xml->videoAssetFilePaths))
				...
				$this->videoAssetFilePaths = \Kaltura\Client\ParseUtils::unmarshalArray($xml->videoAssetFilePaths, "KalturaFreewheelDistributionAssetPath");
		}
	 ...
	 * @var array<KalturaFreewheelDistributionAssetPath>
	 */
