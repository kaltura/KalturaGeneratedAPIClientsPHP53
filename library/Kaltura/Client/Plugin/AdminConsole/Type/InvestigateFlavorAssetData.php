 ...
 * @subpackage Client
 */
class InvestigateFlavorAssetData extends \Kaltura\Client\ObjectBase
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->mediaInfos) && !empty($xml->mediaInfos))
			$this->mediaInfos = \Kaltura\Client\ParseUtils::unmarshalObject($xml->mediaInfos, "KalturaMediaInfoListResponse");
		...
		if(count($xml->flavorParamsOutputs) && !empty($xml->flavorParamsOutputs))
			$this->flavorParamsOutputs = \Kaltura\Client\ParseUtils::unmarshalObject($xml->flavorParamsOutputs, "KalturaFlavorParamsOutputListResponse");
	}
	/**
	 * 
	...
	/**
	 * 
	 * @var \Kaltura\Client\Type\MediaInfoListResponse
	 * @readonly
	 */
	public $mediaInfos;
	...
	/**
	 * 
	 * @var \Kaltura\Client\Type\FlavorParamsOutputListResponse
	 * @readonly
	 */
