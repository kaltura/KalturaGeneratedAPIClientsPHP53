 ...
 * @namespace
 */
namespace Kaltura\Client\Plugin\BpmEventNotificationIntegration\Type;

/**
 * @package Kaltura
 * @subpackage Client
 */
class BpmEventNotificationIntegrationJobTriggerData extends \Kaltura\Client\Plugin\Integration\Type\IntegrationJobTriggerData
{
